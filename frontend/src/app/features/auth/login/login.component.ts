      ...
      <div class="grid w-full max-w-4xl grid-cols-1 overflow-hidden rounded-2xl bg-white shadow-lg md:grid-cols-2">
        <div class="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-brand-900 to-brand-800 p-10 text-white md:flex">
          ...
          <div class="relative">
            ...
            <h2 class="mt-4 text-2xl font-bold leading-snug">{{ 'auth.welcome_back_title' | translate }}</h2>
            <p class="mt-3 text-sm text-white/70">{{ 'auth.welcome_back_subtitle' | translate }}</p>
          </div>
        ...
        <div class="p-8 sm:p-10">
          ...
          <p class="mt-1 text-sm text-slate-500">{{ 'auth.login_subtitle' | translate }}</p>
          ...
          <form class="flex flex-col gap-4" (ngSubmit)="loginWithPassword()">
